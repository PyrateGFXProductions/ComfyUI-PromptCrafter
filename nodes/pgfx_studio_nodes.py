...
NODE_DISPLAY_NAME_MAPPINGS = {
    "PGFX_Studio_Producer": "???? Legacy ?? Studio Config (Producer)",
    "PGFX_Studio_SoundEngineer": "???? Legacy ?? Studio Sound Engineer (Audio)",
    "PGFX_Studio_CreativeDirector": "???? Legacy ?? Studio Creative Director (Concept)",
    "PGFX_Studio_Screenwriter": "???? Legacy ?? Studio Screenwriter (Lyrics)",
    "PGFX_Studio_Director": "???? Legacy ?? Studio Director (Prompts)",
    "PGFX_Studio_Cinematographer": "???? Legacy ?? Studio Scene Router (Cinematographer)",
    "PGFX_Studio_Editor": "???? Legacy ??? Studio Scene Exporter (Editor)",
    "PGFX_Studio_PostMaster": "???? Legacy ??? Studio PostMaster (Final Render)",
    "PGFX_Studio_ProjectContext": "???? Legacy ?? Studio Project Context",
    "PGFX_Studio_StoreText": "???? Legacy ?? Studio Store Text",
    "PGFX_Studio_LoadText": "???? Legacy ?? Studio Load Text",
    "PGFX_Studio_ShotPlannerPromptBuilder": "???? Legacy ?? Studio Shot Planner Prompt Builder",
    "PGFX_Studio_ShotPlanToShotList": "???? Legacy ?? Studio Shot Plan To Shot List",
    "PGFX_Studio_Stylist": "???? Legacy ?? Studio Stylist (Looks)",
    "PGFX_Studio_Animator": "???? Legacy ?? Studio Animator (Visemes)",
    "PGFX_Studio_ScriptSupervisor": "???? Legacy ?? Studio Script Supervisor (Review)",
    "PGFX_Studio_AudioPinAdapter": "???? Legacy ?? Studio Adapter (AUDIOaudio)",
    "PGFX_Studio_ProjectConfigValidator": "???? Legacy ?? Studio Adapter (PROJECT_CONFIG core)",
    "PGFX_Studio_ProjectConfigToSize": "???? Legacy ?? Studio Adapter (PROJECT_CONFIG  Size)",
    "PGFX_Studio_TimingMapAdapter": "???? Legacy ?? Studio Adapter (TIMING_MAP core)",
    "PGFX_Studio_SceneCountAdapter": "???? Legacy ?? Studio Adapter (Scene Count)",
    "PGFX_Studio_AutoQueue": "???? Legacy ?? Studio Auto-Queue (Scenes)",
    "PGFX_Studio_ShotListAdapter": "???? Legacy ?? Studio Adapter (SHOT_LIST core)",
    "PGFX_Studio_CharacterTrackAdapter": "???? Legacy ?? Studio Adapter (CHARACTER_TRACK core)",
}
