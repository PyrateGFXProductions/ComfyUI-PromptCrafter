...
### Creator Nodes
  ...
  - **`PromptCrafter Lyrics Creator`**: A dedicated interface for the powerful lyrics-to-video workflow. This is the node to use when your primary goal is to create a visual storyboard from a song, with support for SRT files for precise timing.
