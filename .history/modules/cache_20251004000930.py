...
class DiskCache:
    ...
    def get(self, key: str):
        ...
        try:
            ...
            print(f"\033[93m[PromptCrafterer Cache] Warning: Could not read cache file {filepath}. Removing it. Error: {e}\033[0m")
    ...
    def set(self, key: str, value: any):
        ...
        try:
            ...
            print(f"\033[91m[PromptCrafterer Cache] Error: Could not serialize value for key '{key}'. Error: {e}\033[0m")
    ...
    def _enforce_size_limit(self):
        ...
        try:
            ...
            if total_size > self.max_size_bytes:
                print(f"\033[94m[PromptCrafterer Cache] Cache size ({total_size/1024**2:.2f}MB) exceeds limit. Evicting oldest items...\033[0m")
            ...
            print(f"\033[91m[PromptCrafterer Cache] Error: Could not enforce cache size limit. Error: {e}\033[0m")
    ...
    def _safe_remove(self, filepath: str) -> bool:
        ...
        try:
            ...
            print(f"\033[91m[PromptCrafterer Cache] Error: Could not remove cache file {filepath}. Error: {e}\033[0m")
            return False
